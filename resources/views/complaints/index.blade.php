                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if($complaints->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <p class="mt-4 text-lg text-gray-500 dark:text-gray-400">You haven't submitted any complaints yet.</p>
                            <a href="{{ route('complaints.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-yellow-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-700">
                                Submit a Complaint
                            </a>
                        </div>
                    @else
                                    ...
                                    @foreach($complaints as $complaint)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                <a href="{{ route('complaints.show', $complaint) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                    {{ $complaint->title }}
                                                </a>
                                                @if($complaint->shift)
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if($complaint->status == 'open')
                                                        <a href="{{ route('complaints.edit', $complaint) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                            Edit
                                                        </a>
