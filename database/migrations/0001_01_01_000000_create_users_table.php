...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('national_insurance_number')->unique();
            $table->boolean('has_enhanced_dbs')->default(false);
            $table->string('dbs_certificate')->nullable();
            $table->enum('nationality', ['UK', 'EU', 'Other']);
            $table->boolean('right_to_work_uk')->default(false);
            $table->string('brp_number')->nullable();
            $table->string('brp_document')->nullable();
            $table->boolean('has_criminal_convictions')->default(false);
